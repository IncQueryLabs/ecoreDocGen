...
public class MissingEcoreDocumentationConstraint0 implements IConstraintSpecification {

    private MissingEcoreDocumentationQuerySpecification querySpecification;

    public MissingEcoreDocumentationConstraint0() throws IncQueryException {
        querySpecification = MissingEcoreDocumentationQuerySpecification.instance();
    }

    @Override
    public String getMessageFormat() {
        return "$host$ is missing the EcoreGen Documentation";
    }
