  ...
  {	  
    switch (classifierID)
    {
      case EcorePackage.EATTRIBUTE:
    	validateDocumentation(value, diagnostics);
	...
	private void validateDocumentation(Object value, DiagnosticChain diagnostics) {
		String documentation = EcoreUtil.getDocumentation((EModelElement) value);
