...
/**
 * Pattern-specific match representation of the ecoredocgen.incquery.tooShortEcoreGenDocumentation pattern, 
 * to be used in conjunction with {@link TooShortEcoreGenDocumentationMatcher}.
 * 
...
public abstract class TooShortEcoreGenDocumentationMatch extends BasePatternMatch {
  ...
  private TooShortEcoreGenDocumentationMatch(final ENamedElement pHost) {
    this.fHost = pHost;
  ...
  public List<String> parameterNames() {
    return TooShortEcoreGenDocumentationMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TooShortEcoreGenDocumentationMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    TooShortEcoreGenDocumentationMatch other = (TooShortEcoreGenDocumentationMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return TooShortEcoreGenDocumentationMatcher.querySpecification().getPattern();
